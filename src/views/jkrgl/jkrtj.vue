<template>
  <div>
      <Tabs>
              ...
              <Row>
                <Col>
                  <Form :label-width="80" :rules="ruleValidate" ref="formValidate" :model="formValidate">
                    ...
                    <FormItem label=入职时间>
                      <DatePicker type="date" placeholder="选择入职时间" v-model="rzsj" style="width:100%;"></DatePicker>
                    </FormItem>
                    <FormItem label=单位地址>
                      <Input v-model="dwdz" />
                    </FormItem>
        ...
        <Tab-pane label="其他信息">标签三的内容</Tab-pane>
        <Tab-pane label="附件信息">标签三的内容</Tab-pane>
    </Tabs>
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      XlList: [
        { value:'博士', label:'博士'},{value:'硕士',label:'硕士'}, {value:'本科', label:'本科'},{value:'大专',label:'大专'},
        { value:'其他', label:'其他'},
      ],
      JkList: [
        { value:'白领贷',label:'白领贷'},{value:'房贷',label:'房贷'},{value:'信用贷',label:'信用贷'}, {value:'精英贷',label:'精英贷'},
        { value:'房产二次抵押贷', label:'房产二次抵押贷'},{value:'全款房抵押贷',label:'全款房抵押贷'}, {value:'税贷', label:'税贷'},
      ],
      area:'',
      ruleValidate: {
        name:[
        ...
        sort:[
          {required:true, message:'请选择贷款类别', trigger: 'blur'}
        ],
        address:[
        ...
        dwxz:[
          {required:true, message:'请填写单位性质', trigger: 'blur'}
        ],
        dwdh:[
        ...
        rzxs:[
          {required:true, message:'请填写任职薪水', trigger: 'blur'}
        ],
        zsr:[
